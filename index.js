...
// Рядковому представленю Vehicle призначаємо функцію
//яка повертає рядок: <brand> <model> <year>
Vehicle.toString = function () {
  return `${this.brand} ${this.model} (${this.year})`;
};
// valueOf - це метод, який використовується JavaScript для конвертації об'єкта
//в примітивне значення.
...
//Створюємо Car - це ще один конструктор, який наслідує властивості і методи з Vehicle
//за допомогою функції apply.
function Car(brand, model, year, mileage, fuelType, speed) {
  // Викликаємо конструктор Vehicle за допомогою apply,
  //передаємо в нього this, [brand, model, year, mileage].
  //  Записуєм в this.fuelType значення аргументу fuelType,
  //в this.speed значення аргументу speed
...
// Рядковому представленю прототипу Car призначаємо функцію
//яка повертає рядок: <brand> <model> <year> - <fuelType>.
...
//збільшує this.speed на передане число та виводить рядок
//в консоль: Автомобіль <brand> <model> прискорився до швидкості <speed> км/год
...
//зменшує this.speed на передане число та виводить рядок в консоль
//в консоль: Автомобіль <brand> <model> зменшив до швидкості <speed> км/год
...
// Додатковий метод tow для прототипу Trucks,
//примає число якщо воно більше towingCapacity
...
// Це створює нову функцію, в якій this постійно встановлено на car,
//незалежно від того, як функцію викликають.
...
function ElectricCar(brand, model, year, mileage, batteryCapacity) {
  ...
  //якщо ні виволимо помилку "Конструктор має бути викликаний з 'new'"
